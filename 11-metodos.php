    ...
    <main class="container my-5">
        ...
        <?php else: ?>
            ...
            <article class="alert alert-warning col-6 mx-auto" role="alert">
                ...
                <p>Por favor, preencha o formulário <a href="11-metodo-GET" title="Acessar o Formulário GET" rel="next">GET</a> ou o formulário <a href="11-metodo-POST" title="Acessar o Formulário POST" rel="next">POST</a>.</p>
