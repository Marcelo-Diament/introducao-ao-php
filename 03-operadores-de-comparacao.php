<?php $tituloDaPagina = "Operadores de Comparação | PHP"; ?>
<?php require_once('./inc/head.php'); ?>

    <?= "<h1>$tituloDaPagina</h1><span><b>Repare que vamos usar as mesmas variáveis \$num11 e \$num12 ao longo do documento</b></span>"; ?>
